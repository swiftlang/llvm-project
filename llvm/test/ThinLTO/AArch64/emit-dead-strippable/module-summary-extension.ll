; This tests that the module summary is properly extended to include
; resilient conditional runtime records information.
...
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ANY-FOO
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ANY-BAR
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ANY-BAZ
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ALL-FOO
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ALL-BAR
; RUN: cat %t/ModuleWithSummary.ll | FileCheck %s --check-prefix=ALL-BAZ
