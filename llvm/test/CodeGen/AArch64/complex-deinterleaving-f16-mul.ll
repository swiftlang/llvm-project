...
; CHECK-NEXT:    fcmla v4.8h, v2.8h, v0.8h, #0
; CHECK-NEXT:    fcmla v5.8h, v3.8h, v1.8h, #0
; CHECK-NEXT:    fcmla v4.8h, v2.8h, v0.8h, #90
; CHECK-NEXT:    fcmla v5.8h, v3.8h, v1.8h, #90
...
; CHECK-NEXT:    fcmla v17.8h, v5.8h, v1.8h, #0
; CHECK-NEXT:    fcmla v18.8h, v6.8h, v2.8h, #0
; CHECK-NEXT:    fcmla v19.8h, v7.8h, v3.8h, #0
; CHECK-NEXT:    fcmla v16.8h, v4.8h, v0.8h, #90
; CHECK-NEXT:    fcmla v17.8h, v5.8h, v1.8h, #90
; CHECK-NEXT:    fcmla v18.8h, v6.8h, v2.8h, #90
; CHECK-NEXT:    fcmla v19.8h, v7.8h, v3.8h, #90
