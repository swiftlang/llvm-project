...
; CHECK-NEXT:    fcmla v5.4s, v3.4s, v1.4s, #0
; CHECK-NEXT:    fcmla v4.4s, v2.4s, v0.4s, #90
; CHECK-NEXT:    fcmla v5.4s, v3.4s, v1.4s, #90
...
; CHECK-NEXT:    fcmla v17.4s, v5.4s, v1.4s, #0
; CHECK-NEXT:    fcmla v18.4s, v6.4s, v2.4s, #0
; CHECK-NEXT:    fcmla v19.4s, v7.4s, v3.4s, #0
; CHECK-NEXT:    fcmla v16.4s, v4.4s, v0.4s, #90
; CHECK-NEXT:    fcmla v17.4s, v5.4s, v1.4s, #90
; CHECK-NEXT:    fcmla v18.4s, v6.4s, v2.4s, #90
; CHECK-NEXT:    fcmla v19.4s, v7.4s, v3.4s, #90
