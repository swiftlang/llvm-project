...
; CHECK-NEXT:    fcmla v1.2d, v5.2d, v2.2d, #0
; CHECK-NEXT:    fcmla v0.2d, v4.2d, v3.2d, #90
; CHECK-NEXT:    fcmla v1.2d, v5.2d, v2.2d, #90
...
; CHECK-NEXT:    ldp q3, q2, [x9]
; CHECK-NEXT:    ldp q4, q5, [x10]
; CHECK-NEXT:    fcmla v1.2d, v4.2d, v3.2d, #0
; CHECK-NEXT:    fcmla v0.2d, v5.2d, v2.2d, #0
; CHECK-NEXT:    fcmla v1.2d, v4.2d, v3.2d, #90
; CHECK-NEXT:    fcmla v0.2d, v5.2d, v2.2d, #90
...
; CHECK-NEXT:    fcmla v1.2d, v17.2d, v5.2d, #0
; CHECK-NEXT:    ldp q19, q18, [x10, #32]
; CHECK-NEXT:    fcmla v0.2d, v16.2d, v4.2d, #0
; CHECK-NEXT:    fcmla v1.2d, v17.2d, v5.2d, #90
; CHECK-NEXT:    fcmla v2.2d, v19.2d, v7.2d, #0
; CHECK-NEXT:    fcmla v0.2d, v16.2d, v4.2d, #90
; CHECK-NEXT:    fcmla v3.2d, v18.2d, v6.2d, #0
; CHECK-NEXT:    fcmla v2.2d, v19.2d, v7.2d, #90
; CHECK-NEXT:    fcmla v3.2d, v18.2d, v6.2d, #90
