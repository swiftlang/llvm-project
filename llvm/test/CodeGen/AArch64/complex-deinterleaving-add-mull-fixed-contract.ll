...
; CHECK-NEXT:    fcmla v18.2d, v6.2d, v4.2d, #90
; CHECK-NEXT:    fcmla v19.2d, v7.2d, v5.2d, #90
...
; CHECK-NEXT:    fcmla v16.2d, v2.2d, v0.2d, #90
; CHECK-NEXT:    fcmla v17.2d, v3.2d, v1.2d, #90
; CHECK-NEXT:    fcmla v18.2d, v4.2d, v6.2d, #270
; CHECK-NEXT:    fcmla v19.2d, v5.2d, v7.2d, #270
; CHECK-NEXT:    fadd v0.2d, v16.2d, v18.2d
; CHECK-NEXT:    fadd v1.2d, v17.2d, v19.2d
; CHECK-NEXT:    ret
entry:
