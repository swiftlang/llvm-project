...
// CHECK: @_ZN1A1fEv.ptrauth.97 = private constant { ptr, i32, i64, i64 } { ptr @_ZN1A1fEv, i32 0, i64 ptrtoint (ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV1B, i32 0, i32 0, i32 2) to i64), i64 55636 }, section "llvm.ptrauth", align 8
// CHECK: @_ZN1A1gEv.ptrauth.98 = private constant { ptr, i32, i64, i64 } { ptr @_ZN1A1gEv, i32 0, i64 ptrtoint (ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV1B, i32 0, i32 0, i32 3) to i64), i64 19402 }, section "llvm.ptrauth", align 8
// CHECK: @_ZN1A1hEz.ptrauth.99 = private constant { ptr, i32, i64, i64 } { ptr @_ZN1A1hEz, i32 0, i64 ptrtoint (ptr getelementptr inbounds ({ [7 x ptr] }, ptr @_ZTV1B, i32 0, i32 0, i32 4) to i64), i64 31735 }, section "llvm.ptrauth", align 8
