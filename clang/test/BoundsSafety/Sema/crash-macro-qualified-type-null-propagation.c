...
//
// Like VisitParenType (see crash-paren-type-null-propagation.c),
// VisitMacroQualifiedType did not propagate the null QualType that a visitor
// returns to signal mid-descent rejection; it passed the possibly-null inner
// type to ASTContext::getMacroQualifiedType, which crashed.
