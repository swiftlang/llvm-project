...
void caller_out_ranges_wrong_args(int *__ended_by(*out_end) *out_start, int **out_end) {
  ...
  // XXX: rdar://97038292
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(*out_start) */ ' (aka 'int *__single') to parameter of type 'int *__single /* __started_by(*out_start) */ *__single' (aka 'int *__single*__single'); remove *}}
  ...
  callee_out_ranges(out_start, *out_end);
  // expected-error@+3{{incompatible pointer types passing 'int *__single __ended_by(*out_end)' (aka 'int *__single') to parameter of type 'int *__single __ended_by(*out_end)*__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(*out_start) */ ' (aka 'int *__single') to parameter of type 'int *__single /* __started_by(*out_start) */ *__single' (aka 'int *__single*__single'); remove *}}
  ...
  callee_out_ranges(*out_start, *out_end);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(*out_end)' (aka 'int *__single') to parameter of type 'int *__single __ended_by(*out_end)*__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+1{{type of 'out_start', 'int *__single __ended_by(*out_end)*__single' (aka 'int *__single*__single'), is incompatible with parameter of type 'int *__single __ended_by(*out_end)' (aka 'int *__single')}}
  callee_out_ranges(*out_start, out_end);
  ...
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(*out_end)' (aka 'int *__single') to parameter of type 'int *__single /* __started_by(*out_start) */ *__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+1{{type of 'out_end', 'int *__single /* __started_by(*out_start) */ ' (aka 'int *__single'), is incompatible with parameter of type 'int *__single __ended_by(*out_end)' (aka 'int *__single')}}
  callee_out_ranges(out_end, *out_start);
  // expected-error@+3{{incompatible pointer types passing 'int *__single /* __started_by(*out_start) */ ' (aka 'int *__single') to parameter of type 'int *__single __ended_by(*out_end)*__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(*out_end)' (aka 'int *__single') to parameter of type 'int *__single /* __started_by(*out_start) */ *__single' (aka 'int *__single*__single'); remove *}}
  ...
  callee_out_ranges(*out_end, *out_start);
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(*out_start) */ ' (aka 'int *__single') to parameter of type 'int *__single __ended_by(*out_end)*__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+1{{type of 'out_end', 'int *__single /* __started_by(*out_start) */ *__single' (aka 'int *__single*__single'), is incompatible with parameter of type 'int *__single __ended_by(*out_end)' (aka 'int *__single')}}
  callee_out_ranges(*out_end, out_start);
}
...
void caller_in_ranges_wrong_args(int *__ended_by(end) start, int *end) {
  ...
  // expected-error@+3{{incompatible pointer types passing 'int *__single __ended_by(end)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __ended_by(end)' (aka 'int *__single'); remove &}}
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(start) */ *__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single /* __started_by(start) */ ' (aka 'int *__single'); remove &}}
  ...
  callee_in_ranges(&start, &end);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(end)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __ended_by(end)' (aka 'int *__single'); remove &}}
  // expected-error@+1{{type of 'start', 'int *__single __ended_by(end)' (aka 'int *__single'), is incompatible with parameter of type 'int *__single __ended_by(end)' (aka 'int *__single')}}
  callee_in_ranges(&start, end);
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(start) */ *__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single /* __started_by(start) */ ' (aka 'int *__single'); remove &}}
  ...
  // expected-error@+3{{incompatible pointer types passing 'int *__single /* __started_by(start) */ *__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __ended_by(end)' (aka 'int *__single'); remove &}}
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(end)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single /* __started_by(start) */ ' (aka 'int *__single'); remove &}}
  ...
  callee_in_ranges(&end, &start);
  // expected-error@+2{{incompatible pointer types passing 'int *__single /* __started_by(start) */ *__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __ended_by(end)' (aka 'int *__single'); remove &}}
  // expected-error@+1{{type of 'end', 'int *__single /* __started_by(start) */ ' (aka 'int *__single'), is incompatible with parameter of type 'int *__single __ended_by(end)' (aka 'int *__single')}}
  callee_in_ranges(&end, start);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __ended_by(end)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single /* __started_by(start) */ ' (aka 'int *__single'); remove &}}
...
void caller_out_count_wrong_args(int *__counted_by(*out_count) *out_buf, int *out_count) {
  ...
  callee_out_count_buf(out_buf, *out_count);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __counted_by(*out_count)' (aka 'int *__single') to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single'); remove *}}
  // expected-error@+1{{non-pointer to safe pointer conversion is not allowed with -fbounds-safety; use '__unsafe_forge_single' or '__unsafe_forge_bidi_indexable'}}
  callee_out_count_buf(*out_buf, *out_count);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __counted_by(*out_count)' (aka 'int *__single') to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single'); remove *}}
  ...
  callee_out_count_buf(*out_buf, out_count);
  // expected-error@+3{{incompatible pointer types passing 'int *__single' to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single'); take the address with &}}
  // expected-error@+2{{incompatible pointer types passing 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single') to parameter of type 'int *__single'; dereference with *}}
  // expected-error@+1{{incompatible dynamic count pointer argument to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single')}}
  callee_out_count_buf(out_count, out_buf);
  // expected-error@+1{{non-pointer to safe pointer conversion is not allowed with -fbounds-safety; use '__unsafe_forge_single' or '__unsafe_forge_bidi_indexable'}}
  callee_out_count_buf(*out_count, out_buf);
  // expected-error@+2{{incompatible pointer types passing 'int *__single' to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single'); take the address with &}}
  // expected-error@+1{{incompatible dynamic count pointer argument to parameter of type 'int *__single __counted_by(*out_count)*__single' (aka 'int *__single*__single')}}
  callee_out_count_buf(out_count, *out_buf);
  // expected-error@+1{{non-pointer to safe pointer conversion is not allowed with -fbounds-safety; use '__unsafe_forge_single' or '__unsafe_forge_bidi_indexable'}}
  callee_out_count_buf(*out_count, *out_buf);
...
void caller_in_count_wrong_args(int *__counted_by(count) buf, int count) {
  ...
  // expected-error@+3{{incompatible pointer types passing 'int *__single __counted_by(count)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __counted_by(count)' (aka 'int *__single'); remove &}}
  ...
  callee_in_count_buf(&buf, &count);
  // expected-error@+2{{incompatible pointer types passing 'int *__single __counted_by(count)*__bidi_indexable' (aka 'int *__single*__bidi_indexable') to parameter of type 'int *__single __counted_by(count)' (aka 'int *__single'); remove &}}
  // expected-error@+1{{incompatible dynamic count pointer argument to parameter of type 'int *__single __counted_by(count)' (aka 'int *__single')}}
  callee_in_count_buf(&buf, count);
  // expected-error@+2{{incompatible pointer to integer conversion passing 'int *__bidi_indexable' to parameter of type 'int'; remove &}}
