...
// O2-NEXT:    br i1 [[OR_COND13]], label %[[CONT12:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O2:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP10]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP11]], label %[[CONT12:.*]], label %[[TRAP11:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP11]]:
...
// O0-NEXT:    br i1 [[TMP12]], label %[[CONT14:.*]], label %[[TRAP13:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP13]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT14]]:
