...
// CHECK-NEXT:    [[DOTNOT48:%.*]] = icmp eq ptr [[BOUND_PTR_ARITH16]], null, !annotation [[META11:![0-9]+]]
// CHECK-NEXT:    br i1 [[DOTNOT48]], label [[BOUNDSCHECK_NULL37:%.*]], label [[BOUNDSCHECK_NOTNULL33:%.*]], !annotation [[META11]]
...
// CHECK-NEXT:    [[OR_COND44:%.*]] = and i1 [[TMP5]], [[TMP6]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[OR_COND44]], label [[BOUNDSCHECK_NULL37]], label [[TRAP:%.*]], {{!prof ![0-9]+}}, !annotation [[META12]]
// CHECK:       boundscheck.null37:
// CHECK-NEXT:    tail call void @use(ptr noundef [[BOUND_PTR_ARITH16]], i32 noundef [[TMP3]]) #[[ATTR3]]
// CHECK-NEXT:    br label [[CLEANUP]]
// CHECK:       cleanup:
// CHECK-NEXT:    [[RETVAL_0:%.*]] = phi i32 [ 0, [[BOUNDSCHECK_NULL37]] ], [ -1, [[ENTRY:%.*]] ]
// CHECK-NEXT:    ret i32 [[RETVAL_0]]
//
int access2(S *p) {
  int *Ptr = p->buf;
