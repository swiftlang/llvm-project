...
// RUN: %clang_cc1 -O0 -triple arm64-apple-iphoneos -fbounds-safety -DVARIANT=0 -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-iphoneos -fbounds-safety -DVARIANT=1 -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-iphoneos -fbounds-safety -DVARIANT=2 -emit-llvm %s -o - | FileCheck %s
...
// CHECK-LABEL: define dso_local i32 @read_fam(
...
// CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META4:![0-9]+]]
// CHECK-NEXT:    [[TMP11:%.*]] = icmp ule ptr [[TMP10]], [[WIDE_PTR_UB7]], !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF5:![0-9]+]], !annotation [[META4]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2:[0-9]+]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP12:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP10]], !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT9:.*]], label %[[TRAP8:.*]], !prof [[PROF5]], !annotation [[META4]]
// CHECK:       [[TRAP8]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT9]]:
// CHECK-NEXT:    [[TMP13:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META6:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT11:.*]], label %[[TRAP10:.*]], !prof [[PROF5]], !annotation [[META6]]
// CHECK:       [[TRAP10]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2]], !annotation [[META6]]
...
// CHECK-LABEL: define dso_local void @write_fam(
...
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR]], align 8
// CHECK-NEXT:    [[TMP11:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META4]]
// CHECK-NEXT:    [[TMP12:%.*]] = icmp ule ptr [[TMP11]], [[WIDE_PTR_UB7]], !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF5]], !annotation [[META4]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP13:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP11]], !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT9:.*]], label %[[TRAP8:.*]], !prof [[PROF5]], !annotation [[META4]]
// CHECK:       [[TRAP8]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT9]]:
// CHECK-NEXT:    [[TMP14:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META6]]
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT11:.*]], label %[[TRAP10:.*]], !prof [[PROF5]], !annotation [[META6]]
// CHECK:       [[TRAP10]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR2]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT11]]:
...
//.
// CHECK: [[META4]] = !{!"bounds-safety-check-ptr-le-upper-bound"}
