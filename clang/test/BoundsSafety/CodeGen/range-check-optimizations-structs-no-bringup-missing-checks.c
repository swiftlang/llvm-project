...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[CMP24_NOT:%.*]] = icmp eq i32 [[SIZE]], 0
// CHECK-NEXT:    br i1 [[CMP24_NOT]], label %[[CLEANUP13:.*]], label %[[FOR_BODY_PREHEADER:.*]]
...
// CHECK:       [[CLEANUP13_LOOPEXIT_SPLIT_LOOP_EXIT]]:
// CHECK-NEXT:    [[BOUND_PTR_ARITH_LE:%.*]] = getelementptr [8 x i8], ptr [[SRC]], i64 [[INDVARS_IV]]
// CHECK-NEXT:    br label %[[CLEANUP13]]
// CHECK:       [[CLEANUP13]]:
// CHECK-NEXT:    [[TMP1:%.*]] = phi ptr [ null, %[[ENTRY]] ], [ [[BOUND_PTR_ARITH_LE]], %[[CLEANUP13_LOOPEXIT_SPLIT_LOOP_EXIT]] ], [ null, %[[FOR_COND]] ]
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP:.*]], label %[[CONT1:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TMP2]], label %[[CLEANUP13]], label %[[TRAP]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[CLEANUP13]]:
...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[CMP38_NOT:%.*]] = icmp eq i32 [[SIZE]], 0
// CHECK-NEXT:    br i1 [[CMP38_NOT]], label %[[CLEANUP24:.*]], label %[[FOR_BODY_PREHEADER:.*]]
// CHECK:       [[FOR_BODY_PREHEADER]]:
// CHECK-NEXT:    [[WIDE_TRIP_COUNT:%.*]] = zext i32 [[SIZE]] to i64
// CHECK-NEXT:    br label %[[FOR_BODY:.*]]
// CHECK:       [[FOR_BODY]]:
