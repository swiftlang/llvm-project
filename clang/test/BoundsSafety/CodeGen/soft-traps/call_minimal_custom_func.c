...
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2:[0-9]+]], !annotation [[META1]]
...
// UNOPT:       [[TRAP1]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2]], !annotation [[META1]]
...
// UNOPT:       [[TRAP3]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2]], !annotation [[META3]]
...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call preserve_allcc void @custom_func() #[[ATTR1:[0-9]+]], !annotation [[META9]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call preserve_allcc void @custom_func() #[[ATTR1]], !annotation [[META9]]
...
// OPT:       [[TRAP3]]:
// OPT-NEXT:    tail call preserve_allcc void @custom_func() #[[ATTR1]], !annotation [[META11]]
...
//.
// OPT: [[META3:![0-9]+]] = !{!"int", [[META4:![0-9]+]], i64 0}
