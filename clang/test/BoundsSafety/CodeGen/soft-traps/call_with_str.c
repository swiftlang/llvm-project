...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call void @__bounds_safety_soft_trap_s(ptr nonnull @trap.reason) #[[ATTR2:[0-9]+]], !annotation [[META9]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call void @__bounds_safety_soft_trap_s(ptr nonnull @trap.reason.1) #[[ATTR2]], !annotation [[META9]]
...
// OPT:       [[TRAP3]]:
// OPT-NEXT:    tail call void @__bounds_safety_soft_trap_s(ptr nonnull @trap.reason.2) #[[ATTR2]], !annotation [[META11]]
