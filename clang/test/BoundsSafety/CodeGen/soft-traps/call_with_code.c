...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call void @__bounds_safety_soft_trap_c(i16 0) #[[ATTR1:[0-9]+]], !annotation [[META9]]
...
// OPT:       [[TRAP3]]:
// OPT-NEXT:    tail call void @__bounds_safety_soft_trap_c(i16 0) #[[ATTR1]], !annotation [[META11]]
