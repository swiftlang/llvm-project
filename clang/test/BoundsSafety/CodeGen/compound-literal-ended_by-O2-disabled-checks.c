...
// CHECK-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[NEW_START]], align 8
// CHECK-NEXT:    store ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], ptr [[ARR]], align 8, !tbaa [[TBAA10:![0-9]+]]
...
// CHECK-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[NEW_START]], align 8
// CHECK-NEXT:    store ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], ptr [[AGG_TMP]], align 8, !tbaa [[TBAA13:![0-9]+]]
...
// CHECK: [[TBAA9]] = !{[[META3]], [[META3]], i64 0}
// CHECK: [[TBAA10]] = !{[[META11:![0-9]+]], [[META7]], i64 0}
// CHECK: [[META11]] = !{!"eb", [[META7]], i64 0, [[META7]], i64 8}
// CHECK: [[TBAA12]] = !{[[META11]], [[META7]], i64 8}
// CHECK: [[TBAA13]] = !{[[META14:![0-9]+]], [[META7]], i64 0}
// CHECK: [[META14]] = !{!"eb_with_other_data", [[META7]], i64 0, [[META7]], i64 8, [[META3]], i64 16}
// CHECK: [[TBAA15]] = !{[[META14]], [[META7]], i64 8}
