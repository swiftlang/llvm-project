...
// CHECK-NEXT:    br i1 [[CMP26_NOT]], label %[[TRAP]], label %[[CONT:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR2:[0-9]+]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    store i32 0, ptr [[X]], align 4, !tbaa [[TBAA12:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// WITHOUT-NEXT:  [[ENTRY:.*:]]
// WITHOUT-NEXT:    store i32 0, ptr [[X]], align 4, !tbaa [[TBAA6:![0-9]+]]
...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[TRAP:.*]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// CHECK:       [[LAND_RHS]]:
// CHECK-NEXT:    [[SUB:%.*]] = add nsw i32 [[COUNT]], -1, !annotation [[META13:![0-9]+]]
...
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    store i32 0, ptr [[BOUND_PTR_ARITH]], align 4, !tbaa [[TBAA12]]
// CHECK-NEXT:    ret void
//
