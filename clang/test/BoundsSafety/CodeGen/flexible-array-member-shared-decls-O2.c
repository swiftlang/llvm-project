...
// CHECK-NEXT:    br i1 [[FLEX_BASE_NULL_CHECK_NOT]], label %[[CONT70:.*]], label %[[FLEX_BASE_NONNULL:.*]], !annotation [[META11]]
// CHECK:       [[FLEX_BASE_NONNULL]]:
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[CALL1]], i64 16
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ugt ptr [[CALL1]], [[TMP1]], !annotation [[META12:![0-9]+]]
// CHECK-NEXT:    [[DOTNOT110:%.*]] = icmp ugt ptr [[TMP1]], [[ADD_PTR3]], !annotation [[META13:![0-9]+]]
// CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[DOTNOT]], i1 true, i1 [[DOTNOT110]], !prof [[PROF14:![0-9]+]], !annotation [[META13]]
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[TRAP]], label %[[CONT70]], !prof [[PROF14]], !annotation [[META12]]
// CHECK:       [[CONT70]]:
// CHECK-NEXT:    [[LEN71:%.*]] = getelementptr inbounds nuw i8, ptr [[CALL1]], i64 8
// CHECK-NEXT:    store i32 [[LEN]], ptr [[LEN71]], align 8, !tbaa [[TBAA15:![0-9]+]]
...
// CHECK:       [[FLEX_BASE_NONNULL]]:
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[CALL1]], i64 16
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ugt ptr [[CALL1]], [[TMP1]], !annotation [[META12]]
// CHECK-NEXT:    [[DOTNOT110:%.*]] = icmp ugt ptr [[TMP1]], [[ADD_PTR3]], !annotation [[META13]]
// CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[DOTNOT]], i1 true, i1 [[DOTNOT110]], !prof [[PROF14]], !annotation [[META13]]
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[TRAP]], label %[[CONT70]], !prof [[PROF14]], !annotation [[META12]]
// CHECK:       [[CONT70]]:
// CHECK-NEXT:    store ptr [[CALL]], ptr [[CALL1]], align 8, !tbaa [[TBAA19]]
// CHECK-NEXT:    [[LEN79:%.*]] = getelementptr inbounds nuw i8, ptr [[CALL1]], i64 8
// CHECK-NEXT:    store i32 [[LEN]], ptr [[LEN79]], align 8, !tbaa [[TBAA15]]
// CHECK-NEXT:    ret ptr [[CALL1]]
//
...
// CHECK: [[PROF14]] = !{!"branch_weights", i32 12286, i32 -12288}
