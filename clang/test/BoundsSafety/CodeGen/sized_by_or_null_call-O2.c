...
// CHECK-NEXT:    store i32 0, ptr [[I]], align 4, !tbaa [[TBAA2:![0-9]+]]
...
// CHECK-NEXT:    br i1 [[SPEC_SELECT]], label [[CONT]], label [[TRAP]], !prof [[PROF13:![0-9]+]], !annotation [[META7]]
// CHECK:       trap:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR6]], !annotation [[META7]]
// CHECK-NEXT:    unreachable, !annotation [[META7]]
// CHECK:       cont:
...
// CHECK-NEXT:    br i1 [[OR_COND]], label [[CONT:%.*]], label [[TRAP:%.*]], !prof [[PROF14:![0-9]+]], !annotation [[META7]]
// CHECK:       trap:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR6]], !annotation [[META7]]
// CHECK-NEXT:    unreachable, !annotation [[META7]]
// CHECK:       cont:
...
// CHECK-NEXT:    [[CMP_NOT172:%.*]] = icmp slt i32 [[TMP1]], 0, !annotation [[META7]]
// CHECK-NEXT:    [[CMP_NOT:%.*]] = select i1 [[DOTNOT]], i1 [[CMP_NOT172]], i1 false, !annotation [[META7]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label [[TRAP:%.*]], label [[LAND_RHS:%.*]], !annotation [[META7]]
// CHECK:       trap:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR6]], !annotation [[META16:![0-9]+]]
// CHECK-NEXT:    unreachable, !annotation [[META16]]
// CHECK:       land.rhs:
// CHECK-NEXT:    br i1 [[DOTNOT]], label [[LOR_RHS:%.*]], label [[CONT146:%.*]], !annotation [[META7]]
// CHECK:       lor.rhs:
// CHECK-NEXT:    [[CMP63:%.*]] = icmp sge i32 [[TMP1]], [[LEN]], !annotation [[META7]]
// CHECK-NEXT:    [[CMP66:%.*]] = icmp sgt i32 [[LEN]], -1, !annotation [[META7]]
// CHECK-NEXT:    [[SPEC_SELECT:%.*]] = and i1 [[CMP66]], [[CMP63]]
// CHECK-NEXT:    br i1 [[SPEC_SELECT]], label [[CONT146]], label [[TRAP]], !prof [[PROF13]], !annotation [[META7]]
// CHECK:       cont146:
