...
// CHECK-NEXT: {{^}}|-FunctionDecl [[func_caller_1:0x[^ ]+]] {{.+}} caller_1
...
// CHECK-NEXT: {{^}}|     | | | |-OpaqueValueExpr [[ove:0x[^ ]+]] {{.*}} 'int *__single __counted_by_or_null(len)':'int *__single'
...
// CHECK-NEXT: {{^}}|     | | | |-ImplicitCastExpr {{.+}} 'void (*__single)(int *__single __counted_by_or_null(len), int)' <FunctionToPointerDecay>
// CHECK-NEXT: {{^}}|     | | | | `-DeclRefExpr {{.+}} [[func_foo]]
// CHECK-NEXT: {{^}}|     | | | |-OpaqueValueExpr [[ove_2:0x[^ ]+]] {{.*}} 'int *__single __counted_by_or_null(len)':'int *__single'
...
// CHECK-NEXT: {{^}}|     | |   | | |-OpaqueValueExpr [[ove_5]] {{.*}} 'int *__single __counted_by_or_null(len)':'int *__single'
// CHECK:      {{^}}|     | |   | | |-BinaryOperator {{.+}} 'int *' '+'
// CHECK-NEXT: {{^}}|     | |   | | | |-ImplicitCastExpr {{.+}} 'int *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}|     | |   | | | | `-OpaqueValueExpr [[ove_5]] {{.*}} 'int *__single __counted_by_or_null(len)':'int *__single'
// CHECK:      {{^}}|     | |   | | | `-OpaqueValueExpr [[ove_6]] {{.*}} 'int'
// CHECK:      {{^}}|     | |   | |-OpaqueValueExpr [[ove_5]]
// CHECK-NEXT: {{^}}|     | |   | | `-ImplicitCastExpr {{.+}} 'int *__single __counted_by_or_null(len)':'int *__single' <LValueToRValue>
...
// CHECK-NEXT: {{^}}|   `-MaterializeSequenceExpr {{.+}} <Unbind>
// CHECK-NEXT: {{^}}|     |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|     | |-BoundsCheckExpr {{.+}} '&i <= __builtin_get_pointer_upper_bound(&i) && __builtin_get_pointer_lower_bound(&i) <= &i && !&i || -1 <= __builtin_get_pointer_upper_bound(&i) - &i && 0 <= -1'
// CHECK-NEXT: {{^}}|     | | |-CallExpr
// CHECK-NEXT: {{^}}|     | | | |-ImplicitCastExpr {{.+}} 'void (*__single)(int *__single __counted_by_or_null(len), int)' <FunctionToPointerDecay>
// CHECK-NEXT: {{^}}|     | | | | `-DeclRefExpr {{.+}} [[func_foo]]
// CHECK-NEXT: {{^}}|     | | | |-ImplicitCastExpr {{.+}} 'int *__single __counted_by_or_null(len)':'int *__single' <BoundsSafetyPointerCast>
...
// CHECK-NEXT: {{^}}|   `-MaterializeSequenceExpr {{.+}} <Unbind>
// CHECK-NEXT: {{^}}|     |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|     | |-BoundsCheckExpr {{.+}} '&i <= __builtin_get_pointer_upper_bound(&i) && __builtin_get_pointer_lower_bound(&i) <= &i && !&i || 2 <= __builtin_get_pointer_upper_bound(&i) - &i && 0 <= 2'
// CHECK-NEXT: {{^}}|     | | |-CallExpr
// CHECK-NEXT: {{^}}|     | | | |-ImplicitCastExpr {{.+}} 'void (*__single)(int *__single __counted_by_or_null(len), int)' <FunctionToPointerDecay>
// CHECK-NEXT: {{^}}|     | | | | `-DeclRefExpr {{.+}} [[func_foo]]
// CHECK-NEXT: {{^}}|     | | | |-ImplicitCastExpr {{.+}} 'int *__single __counted_by_or_null(len)':'int *__single' <BoundsSafetyPointerCast>
...
// CHECK-NEXT: {{^}}|     | |   |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|     | |   | |-BoundsSafetyPointerPromotionExpr {{.+}} 'int *__bidi_indexable'
// CHECK-NEXT: {{^}}|     | |   | | |-OpaqueValueExpr [[ove_13]] {{.*}} 'int *__single __counted_by(len)':'int *__single'
// CHECK:      {{^}}|     | |   | | |-BinaryOperator {{.+}} 'int *' '+'
// CHECK-NEXT: {{^}}|     | |   | | | |-ImplicitCastExpr {{.+}} 'int *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}|     | |   | | | | `-OpaqueValueExpr [[ove_13]] {{.*}} 'int *__single __counted_by(len)':'int *__single'
...
// CHECK-NEXT: {{^}}|     |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}|     | |-CallExpr
// CHECK-NEXT: {{^}}|     | | |-ImplicitCastExpr {{.+}} 'void (*__single)(int *__single __counted_by(*len)*__single, int *__single)' <FunctionToPointerDecay>
// CHECK-NEXT: {{^}}|     | | | `-DeclRefExpr {{.+}} [[func_bar]]
// CHECK-NEXT: {{^}}|     | | |-OpaqueValueExpr [[ove_20:0x[^ ]+]] {{.*}} 'int *__single __counted_by(*len)*__single'
// CHECK:      {{^}}|     | | `-OpaqueValueExpr [[ove_21:0x[^ ]+]] {{.*}} 'int *__single'
// CHECK:      {{^}}|     | |-OpaqueValueExpr [[ove_20]]
// CHECK-NEXT: {{^}}|     | | `-ImplicitCastExpr {{.+}} 'int *__single __counted_by(*len)*__single' <LValueToRValue>
...
// CHECK-NEXT: {{^}}|     |-OpaqueValueExpr [[ove_20]] {{.*}} 'int *__single __counted_by(*len)*__single'
...
// CHECK-NEXT: {{^}}    | | | |-ImplicitCastExpr {{.+}} 'void (*__single)(int *__single __counted_by(*len)*__single, int *__single)' <FunctionToPointerDecay>
// CHECK-NEXT: {{^}}    | | | | `-DeclRefExpr {{.+}} [[func_bar]]
// CHECK-NEXT: {{^}}    | | | |-ImplicitCastExpr {{.+}} 'int *__single __counted_by(*len)*__single' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}    | | | | `-OpaqueValueExpr [[ove_22:0x[^ ]+]] {{.*}} 'int *__single __counted_by_or_null(count)*__bidi_indexable'
...
// CHECK-NEXT: {{^}}    | |-OpaqueValueExpr [[ove_22]] {{.*}} 'int *__single __counted_by_or_null(count)*__bidi_indexable'
// CHECK:      {{^}}    | `-OpaqueValueExpr [[ove_23]] {{.*}} 'int *__bidi_indexable'
// CHECK:      {{^}}    |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}    | |-BoundsCheckExpr {{.+}} 'p <= __builtin_get_pointer_upper_bound(p) && __builtin_get_pointer_lower_bound(p) <= p && !p || len <= __builtin_get_pointer_upper_bound(p) - p && 0 <= len'
// CHECK-NEXT: {{^}}    | | |-BinaryOperator {{.+}} 'int *__single __counted_by_or_null(count)':'int *__single' '='
// CHECK-NEXT: {{^}}    | | | |-DeclRefExpr {{.+}} [[var_p_5]]
...
// CHECK-NEXT: {{^}}    | |   |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}    | |   | |-BoundsSafetyPointerPromotionExpr {{.+}} 'int *__bidi_indexable'
// CHECK-NEXT: {{^}}    | |   | | |-OpaqueValueExpr [[ove_25]] {{.*}} 'int *__single __counted_by_or_null(count)':'int *__single'
// CHECK:      {{^}}    | |   | | |-BinaryOperator {{.+}} 'int *' '+'
// CHECK-NEXT: {{^}}    | |   | | | |-ImplicitCastExpr {{.+}} 'int *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}    | |   | | | | `-OpaqueValueExpr [[ove_25]] {{.*}} 'int *__single __counted_by_or_null(count)':'int *__single'
// CHECK:      {{^}}    | |   | | | `-OpaqueValueExpr [[ove_26]] {{.*}} 'int'
// CHECK:      {{^}}    | |   | |-OpaqueValueExpr [[ove_25]]
// CHECK-NEXT: {{^}}    | |   | | `-ImplicitCastExpr {{.+}} 'int *__single __counted_by_or_null(count)':'int *__single' <LValueToRValue>
// CHECK-NEXT: {{^}}    | |   | |   `-DeclRefExpr {{.+}} [[var_p_5]]
...
// CHECK-NEXT: {{^}}      `-BoundsCheckExpr {{.+}} 'p <= __builtin_get_pointer_upper_bound(p) && __builtin_get_pointer_lower_bound(p) <= p && !p || len <= __builtin_get_pointer_upper_bound(p) - p && 0 <= len'
// CHECK-NEXT: {{^}}        |-ImplicitCastExpr {{.+}} 'int *__single __counted_by_or_null(len)':'int *__single' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}        | `-OpaqueValueExpr [[ove_28:0x[^ ]+]] {{.*}} 'int *__bidi_indexable'
// CHECK:      {{^}}        |     | | |-OpaqueValueExpr [[ove_29:0x[^ ]+]] {{.*}} 'int *__single __counted_by_or_null(count)':'int *__single'
// CHECK:      {{^}}        |     | | | `-OpaqueValueExpr [[ove_30:0x[^ ]+]] {{.*}} 'int'
// CHECK:      {{^}}        |-BinaryOperator {{.+}} 'int' '&&'
// CHECK-NEXT: {{^}}        | |-BinaryOperator {{.+}} 'int' '&&'
// CHECK-NEXT: {{^}}        | | |-BinaryOperator {{.+}} 'int' '<='
// CHECK-NEXT: {{^}}        | | | |-ImplicitCastExpr {{.+}} 'int *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}        | | | | `-OpaqueValueExpr [[ove_28]] {{.*}} 'int *__bidi_indexable'
// CHECK:      {{^}}        | | | `-GetBoundExpr {{.+}} upper
// CHECK-NEXT: {{^}}        | | |   `-OpaqueValueExpr [[ove_28]] {{.*}} 'int *__bidi_indexable'
// CHECK:      {{^}}        | | `-BinaryOperator {{.+}} 'int' '<='
// CHECK-NEXT: {{^}}        | |   |-GetBoundExpr {{.+}} lower
...
// CHECK-NEXT: {{^}}        |   |-MaterializeSequenceExpr {{.+}} <Bind>
// CHECK-NEXT: {{^}}        |   | |-BoundsSafetyPointerPromotionExpr {{.+}} 'int *__bidi_indexable'
// CHECK-NEXT: {{^}}        |   | | |-OpaqueValueExpr [[ove_29]] {{.*}} 'int *__single __counted_by_or_null(count)':'int *__single'
// CHECK:      {{^}}        |   | | |-BinaryOperator {{.+}} 'int *' '+'
// CHECK-NEXT: {{^}}        |   | | | |-ImplicitCastExpr {{.+}} 'int *' <BoundsSafetyPointerCast>
// CHECK-NEXT: {{^}}        |   | | | | `-OpaqueValueExpr [[ove_29]] {{.*}} 'int *__single __counted_by_or_null(count)':'int *__single'
