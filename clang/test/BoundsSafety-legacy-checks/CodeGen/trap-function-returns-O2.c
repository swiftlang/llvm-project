...
// X86_64-SAME: ptr nofree noundef readonly captures(address) [[BAR:%.*]], i32 noundef [[COUNT:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// X86_64-NEXT:  entry:
...
// X86_64-NEXT:    [[TMP0:%.*]] = icmp ult ptr [[ARRAYIDX]], [[ADD_PTR]], !annotation [[META5:![0-9]+]]
// X86_64-NEXT:    br i1 [[TMP0]], label [[CONT:%.*]], label [[TRAP:%.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// X86_64:       trap:
// X86_64-NEXT:    tail call void @fb_trap(i8 25) #[[ATTR1:[0-9]+]], !annotation [[META5]]
// X86_64-NEXT:    br label [[CONT]], !annotation [[META5]]
// X86_64:       cont:
// X86_64-NEXT:    [[DOTNOT:%.*]] = icmp ult ptr [[ARRAYIDX]], [[BAR]], !annotation [[META7:![0-9]+]]
// X86_64-NEXT:    br i1 [[DOTNOT]], label [[TRAP1:%.*]], label [[CONT2:%.*]], {{!prof ![0-9]+}}, !annotation [[META7]]
// X86_64:       trap1:
// X86_64-NEXT:    tail call void @fb_trap(i8 25) #[[ATTR1]], !annotation [[META7]]
// X86_64-NEXT:    br label [[CONT2]], !annotation [[META7]]
// X86_64:       cont2:
