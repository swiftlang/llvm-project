...
public:
  ...
  virtual CompilerType GetTypeFromMangledTypename(ConstString mangled_typename,
                                                  Status &error);
  ...
  virtual bool IsImportedType(void *type,
                              CompilerType *original_type = nullptr);
...
protected:
  ...
  virtual void InstallSwiftModuleLoaders(
...
public:
  ...
  static SwiftASTContextForExpressions *
  ...
  const swift::SearchPathOptions *GetSearchPathOptionPtr() const;
  ...
  swift::TypeBase *GetSwiftTypeFromMangledTypename(ConstString mangled_typename,
                                                   Status &error);
  ...
  virtual bool IsImportedType(void *type, CompilerType *original_type);
  ...
  /// Used by the Optional data formatter.
  ...
  /// Used by dynamic type resolution.
  ...
  CompilerType GetChildCompilerTypeAtIndex(
      ...
      bool &child_is_base_class, bool &child_is_deref_of_parent,
      ValueObject *valobj, uint64_t &language_flags) override;
  size_t GetIndexOfChildMemberWithName(void *type, const char *name,
                                       bool omit_empty_base_classes,
                                       std::vector<uint32_t> &child_indexes,
  ...
  static bool
  PerformUserImport(SwiftASTContextForExpressions &swift_ast_context,
                    SymbolContext &sc, ExecutionContextScope &exe_scope,
                    lldb::StackFrameWP &stack_frame_wp,
                    swift::SourceFile &source_file, Status &error);

  static bool
  PerformAutoImport(SwiftASTContextForExpressions &swift_ast_context,
                    SymbolContext &sc, lldb::StackFrameWP &stack_frame_wp,
                    swift::SourceFile *source_file, Status &error);

private:
  void InstallSwiftModuleLoaders(
      std::unique_ptr<swift::ClangImporter> clang_importer_up) override;
