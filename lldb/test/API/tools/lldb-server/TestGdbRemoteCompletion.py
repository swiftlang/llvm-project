...
class GdbRemoteCompletionTestCase(gdbremote_testcase.GdbRemoteTestCaseBase):
    def init_lldb_server(self):
        ...
        commandline_args = ["platform", "--listen", "*:0", "--socket-file", port_file]
    ...
    def test_autocomplete_path(self):
        ...
        self.test_sequence.add_log_lines(
            [
                ...
                "send packet: $M{},{}#00".format(
                    self.generate_hex_path("main.d"), self.generate_hex_path("main.o")
                ),
            ],
            True,
        )
        ...
        self.test_sequence.add_log_lines(
            [
                ...
                "send packet: $M{}{}#00".format(
                    self.generate_hex_path("test"), os.path.sep.encode().hex()
                ),  # "test/" or "test\".
            ],
            True,
        )
