...
class AnonymousTestCase(TestBase):
    ...
    def test_expr_nest(self):
        ...
        self.expect(
            "expression n->foo.d", VARIABLES_DISPLAYED_CORRECTLY, substrs=["= 4"]
        )
    ...
    def test_expr_child(self):
        ...
        # These should display correctly.
        self.expect(
            "expression c->foo.d", VARIABLES_DISPLAYED_CORRECTLY, substrs=["= 4"]
        )

        self.expect(
            "expression c->grandchild.b", VARIABLES_DISPLAYED_CORRECTLY, substrs=["= 2"]
        )
    ...
    def test_expr_grandchild(self):
        ...
        # These should display correctly.
        self.expect(
            "expression g.child.foo.d", VARIABLES_DISPLAYED_CORRECTLY, substrs=["= 4"]
        )
    ...
    def test_nest_flat(self):
        ...
        # These should display correctly.
        self.expect(
            "frame variable n --flat",
            substrs=["n.a = 0", "n.b = 2", "n.foo.c = 0", "n.foo.d = 4"],
        )
