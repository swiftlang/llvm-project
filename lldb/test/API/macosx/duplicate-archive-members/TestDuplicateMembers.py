...
class BSDArchivesTestCase(TestBase):
    def test(self):
        ...
        lldbutil.run_break_set_by_symbol(self, "a", sym_exact=True)
        lldbutil.run_break_set_by_symbol(self, "b", sym_exact=True)
